<template>
  <div class="traveller-form-block">
    <form class="traveller-form">
      <div v-if="main" class="form-row mb-3 d-flex justify-content-end">
        <a
          href="#"
          class="btn btn-add-traveller btn-success text-white"
          style="margin: 0;"
        >
          <span>{{ __('Main Customer') }}</span>
        </a>
      </div>
            ...
            <div class="col-sm-8">
              <div class="position-relative small-input">
                <select
                  ...
                  class="custom-select small-input"
                  required
                ...
                <i
                  ...
                  style="right: 20px; position: absolute; top: 14px; font-weight: 600;"
                />
              </div>
            ...
            <div class="col-sm-8">
              <div class="mobile-input">
                <div class="position-relative">
                  <select
                    class="custom-select phone-prefix-select"
                  ...
                  <i
                    class="fa fa-angle-down"
                    style="right: 8px; position: absolute; top: 14px; font-weight: 600;"
                  />
                </div>
    ...
    <div class="d-flex justify-content-center align-items-center">
      <a
        href="#"
        class="btn-booking"
        @click.prevent="$store.commit('setCheckoutStep', 1)"
      >
        {{ __('Continue Booking') }}
      </a>
    </div>
    ...
    validate () {
      ...
      Object.keys(this.traveller).forEach(key => {
        if (!excludeKeys.includes(key) && (
          ...
          || (this.traveller.type !== 'adults' && !excludeKeysForChildren.includes(key))
        )) {
